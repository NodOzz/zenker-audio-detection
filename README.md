...
│   └── run_batch_simple_2stage.py             # Batch inference script
│
...
```
This script optimizes the detection threshold based on validation F1 score per fold. This can then be passed to the `src/run_batch_simple_2stage.py` or `run_all_folds_simple_batch.sh`.
